...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtLocation; Button btnSelect, btnSend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Referencing File Location
        txtLocation = (TextView) findViewById(R.id.txtFileLocation);
        btnSelect = (Button) findViewById(R.id.btnSelectFile);
        btnSelect.setOnClickListener(v -> {
            // When Select File button is clicked
            txtLocation.setText("");
            openFile();
        });
        //Referencing Send File Button
        btnSend = (Button) findViewById(R.id.btnSendFile);
        //When Send File button is clicked
        btnSend.setOnClickListener(v -> sendViaBluetooth());
    }
    ...
    //Function which is called when using outside application functions @Override
        ...
        switch (requestCode) {
            ...
            case REQUEST_BLUETOOTH: //When Requesting Bluetooth
                ...
                Intent BTIntent = new Intent(); //Intent for Sending via Bluetooth
                    ...
                    if (list.size() > 0) {
                        ...
                        if (!found) {
                            Toast.makeText(this, "Could not find Bluetooth",
            ...
            default:
                Toast.makeText(MainActivity.this,
                        "Unknown Request Code Encountered",
                        Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void sendViaBluetooth() {
        if(!txtLocation.getText().toString().equals("")) {
            ...
            if (BTAdapter == null) {
                //If Bluetooth functionality doesn't exist
                Toast.makeText(this,
    ...
    public void enableBluetooth() {
        //Intent to request Discoverable Bluetooth Devices
